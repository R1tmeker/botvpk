...
class ScheduleEvent(Base):
    ...
    requires_response: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="true")
    self_checkin_enabled: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
    self_checkin_opens_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    self_checkin_closes_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    late_after_minutes: Mapped[int] = mapped_column(Integer, nullable=False, server_default="5")
